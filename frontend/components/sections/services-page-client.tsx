...
const TIERS = [
  {
    ...
    badge: null,
    features: [
      "University search & ranking tool",
  ...
  },
  {
    ...
    features: [
      "Everything in Free",
      "3 universities — full application support",
      "SOP review (2 rounds)",
  ...
  },
  {
    ...
    features: [
      ...
      "Unlimited SOP/LOR revisions",
      "Mock visa interview",
      "Pre-departure briefing",
      "WhatsApp priority support",
    ],
    cta: "Chat on WhatsApp",
    ctaHref: `https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || "919999999999"}?text=Hi%2C%20I%20am%20interested%20in%20the%20Premium%20plan`,
    solid: false,
  },
];
...
function PricingCard({ t, index }: { t: (typeof TIERS)[0]; index: number }) {
  const ref = useRef<HTMLDivElement>(null);
  ...
  return (
    <div
      ref={ref}
      style={{
        border: t.badge ? "1.5px solid var(--fg)" : "1px solid var(--border)",
        borderRadius: 16,
        padding: "2rem",
        background: "var(--elev)",
        display: "flex",
    ...
    >
      ...
      <Link
        ...
        style={{
          ...
          borderRadius: 9999,
          border: "1px solid var(--fg)",
          background: t.solid ? "var(--fg)" : "transparent",
          color: t.solid ? "var(--bg)" : "var(--fg)",
          fontFamily: "var(--font-mono, 'JetBrains Mono', monospace)",
          fontSize: 11,
          fontWeight: 600,
        ...
        onMouseLeave={(e) => {
          (e.currentTarget as HTMLAnchorElement).style.background = t.solid
            ? "var(--fg)"
            : "transparent";
          (e.currentTarget as HTMLAnchorElement).style.color = t.solid
            ? "var(--bg)"
            : "var(--fg)";
        }}
      >
      ...
      >
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "4rem" }}>
            ...
            >
              Pick the level of support that fits your needs. Upgrade anytime
          ...
          >
            {TIERS.map((t, i) => (
              <PricingCard key={t.tier} t={t} index={i} />
            ))}
          </div>
        </div>
      </section>
