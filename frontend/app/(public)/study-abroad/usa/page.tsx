...
export const metadata: Metadata = { title: "Study in USA" };
...
const HIGHLIGHTS = [
  { text: "World-class research universities" },
                { text: "OPT work authorization post-study" },
                { text: "Diverse campus culture" },
                { text: "Strong alumni networks" },
];
    ...
    <Box>
      <Box sx={{ background: "linear-gradient(135deg, #1d4ed8 0%, #2563eb 100%)", py: { xs: 10, md: 14 }, px: { xs: 3, md: 6 }, color: "white" }}>
        <Box sx={{ maxWidth: 860, mx: "auto", textAlign: "center" }}>
          ...
          <Typography variant="h3" fontWeight={900} mb={2}>Study in USA</Typography>
          <Typography sx={{ opacity: 0.85, fontSize: 18, mb: 5 }}>
            Explore 180+ universities with expert counselor support.
          </Typography>
          <Button
            component={Link}
            href="/consultation"
      ...
      <Box sx={{ py: { xs: 8, md: 12 }, px: { xs: 3, md: 6 } }}>
        <Box sx={{ maxWidth: 1100, mx: "auto" }}>
          ...
          <Card elevation={0} sx={{ border: "1px solid", borderColor: "divider", mb: 8 }}>
            <CardContent sx={{ p: 4 }}>
              <Typography variant="h5" fontWeight={700} mb={3}>Why Study in USA?</Typography>
          ...
          <Typography variant="h5" fontWeight={700} mb={4}>Universities in USA</Typography>
          <UniversityListClient defaultCountry="usa" />
        </Box>
      </Box>
    </Box>
  );
